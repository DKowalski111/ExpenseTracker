      ...
      <div className="container">
        ...
        <div id="navcol-5" className="collapse navbar-collapse text-end">
          <ul className="navbar-nav ms-auto">
            ...
            <li className="nav-item"><Link className="nav-link active" to="#">Expenses</Link></li>
            <li className="nav-item"><Link className="nav-link active" to="/analytics">Analytics</Link></li>
            <li className="nav-item"><Link className="nav-link active" to="#">Settings</Link></li>
          </ul>
          <Link className="btn btn-light ms-md-2" role="button" to="#" style={{ background: '#d9480f', borderStyle: 'none', color: '#dbffff' }}>Add expense</Link>
        </div>
      </div>
    </nav>
  );
