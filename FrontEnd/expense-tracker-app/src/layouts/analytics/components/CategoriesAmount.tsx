...
const CategoriesAmount: React.FC<{ categoriesAmount: CategoriesAmountProps | undefined }> = (props) => {
  ...
  // if (props.categoriesAmount) {
  //   labels = Object.keys(props.categoriesAmount);
  //   values = Object.values(props.categoriesAmount).map(parseFloat);
  // } else {
  //   console.error('props.categoriesAmount is undefined');
  // }
